    ...
    <div id="app">
        <div id="contain">
            <div id="questions">
                ...
                IL EST TEMPS D'INDIQUER QUI EST LE COUPABLE.
            </div>

                <button class="sus1"><router-link
                            to="/aventure"><img src='@/assets/sus1.png'/></router-link></button>
                            <button class="sus2"><router-link
                            to="/aventure"><img src='@/assets/sus2.png'/></router-link></button>
                            <button class="sus3"><router-link
                            to="/aventure"><img src='@/assets/sus3.png'/></router-link></button>
