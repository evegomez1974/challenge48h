<template>
    ...
    <div id="app">
        <div id="contain">
            <div id="questions">
                BIEN JOUÉ, LE COUPABLE NE FAISAIT PAS PARTIE DE LA LISTE DES TROIS SUS, MAIS C'ETAIT LUI :  
                <img src="@/assets/chatsus.jpg" />
            </div>
            <img src="@/assets/chatshocked.jpg" />
            <img src="@/assets/chatshocked.jpg" />
            <img src="@/assets/chatshocked.jpg" />
            <img src="@/assets/chatshocked.jpg" />
            <img src="@/assets/chatshocked.jpg" />
            ...
            <img class="chakitourne" src="@/assets/chatshocked.jpg" />
            
            <img class="chakitourne2" src="@/assets/chatshocked.jpg" />
            
            <p>
                <button class="button"><router-link
                            to="/">Retour à l'accueil</router-link></button></p> 
        </div>
    </div>
</template>
